...
import { Save, Share2, Check, Info, Lock } from 'lucide-react'
...
export function ProfitCalculatorPanel({ user }: { user: SupabaseUser | null }) {
  ...
  function handleShare() {
    ...
    const url = `${window.location.origin}/testing?tab=calculator&${params.toString()}`
