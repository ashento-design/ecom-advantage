...
import { LayoutDashboard, Package, Users, Rocket, ArrowLeft, LogOut, BarChart3, PackagePlus, ListChecks, Quote, Compass } from 'lucide-react'
...
const navItems = [
  ...
  { label: 'Discover Products', href: '/admin/discover', icon: Compass },
